...
*/
        ...
        .form-select {
            ...
            color: #212529;
            background-color: #fff;
            background-image: url("https://th.bing.com/th/id/R.2e1ed7923dde301decb19853c1a90958?rik=ByqeKrVC9yRIzA&pid=ImgRaw&r=0");
...
<body id="page-top">
    ...
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="#page-top">ArtsyCollabs</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                @guest
                    <li class="nav-item"><a class="nav-link" href="{{ route('login') }}" style="color: #C66D28;">Log in</a></li>

                    @if (Route::has('register'))
                        <li class="nav-item"><a class="nav-link" href="{{ route('register') }}" style="color: #C66D28;">Register</a></li>
                    @endif
                @else
                    <li class="nav-item"><a href="{{ url('/home') }}" class="nav-link" style="color: #C66D28;">Home</a></li>
                @endguest
            </ul>
        </div>
    </div>
    ...
    <!-- Masthead-->
    <header class="masthead" style="background-image: url('https://images.fineartamerica.com/images-medium-large-5/7-starry-night-vincent-van-gogh.jpg'); " >
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold"> ArtsyCollabs </h1>
                    <hr class="divider" />
                </div>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-75 mb-4"> Dive into our curated collection of artistic treasures—masterpieces, avant-garde works, and hidden gems await. Ready to embark on your next creative adventure? Connect with fellow artists, explore collaborative projects, and let the strokes of inspiration transport you to new realms of artistic expression!</p>
